/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: 65b3921ab1334acdcf76cfda203c08fa)
// Runtime types generated with workerd@1.20260310.1 2026-01-27 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ASSETS: Fetcher;
		GOATCOUNTER_ENDPOINT: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOATCOUNTER_ENDPOINT" | "UPSTASH_REDIS_REST_URL" | "UPSTASH_REDIS_REST_TOKEN">> {}
}
